  ...
  const {
    ...
    setProfileSourceReservation, setProfileSourceTab,
            ...
            ed.rooms.forEach((room, i) => {
              ...
              billableItems.push({ key: `room-${i}`, type: 'room', roomNumber: room.roomNumber, label: `Room ${room.roomNumber}`, detail: `${room.roomType} · ${roomNights} night${roomNights !== 1 ? 's' : ''} · ${dateRange}`, amount, vatRate: hotelSettings.defaultRoomVat });
            });
