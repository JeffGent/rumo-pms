...
const InvoiceModal = (props) => {
  const { invoiceOpen, setInvoiceOpen } = props;
    ...
    const [invoiceLines, setInvoiceLines] = useState([{ description: '', qty: 1, price: '' }]);
        ...
        <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl border border-neutral-200 overflow-hidden max-h-[90vh] flex flex-col"
          ...
          <div className="p-4 md:p-6 space-y-5 overflow-y-auto flex-1">
                ...
                {invoiceLines.map((line, i) => (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <div className="relative">
                      <span className="absolute left-2.5 top-1/2 -translate-y-1/2 text-sm text-neutral-400">&euro;</span>
            ...
            <div className="flex items-center justify-between pt-3 border-t border-neutral-100">
              ...
              <span className="text-xl font-bold text-neutral-900">&euro;{total.toFixed(2)}</span>
            </div>
          </div>
